...
const modalViews = document.querySelectorAll('.qualification__modal'),
    modalBtns = document.querySelectorAll('.qualification__learn'),
...
/*==================== ACTIVE LINK QUALIFICATION ====================*/ 

const educationTitle = document.getElementById('educationLinkTitle')
const workTitle = document.getElementById('workLinkTitle')

educationTitle.addEventListener('click', () => {
    educationTitle.classList.add('active-link')
    workTitle.classList.remove('active-link')
})

workTitle.addEventListener('click', () => {
    workTitle.classList.add('active-link')
    educationTitle.classList.remove('active-link') 
})
...
themeButton.addEventListener('click', () => {
    // Title theme
    // statusTitleTheme?themeButton.title = "Ligth theme":themeButton.title = "Dark theme";
    // statusTitleTheme=!statusTitleTheme
...
function downloadCV(){
    ...
    var languageTitle = languageButton.title;
